...
<div class="card card-primary facility_group_detail">
    <form class="form-horizontal" action="{{ route('facility.group.regexec') }}" method="post" id="facility-group-edit" accept-charset="utf-8">
        @csrf
        <div class="card-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">施設グループ登録</h5><button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <p class="tac text">この施設グループを登録してよろしいでしょうか？</p>
                    </div>
