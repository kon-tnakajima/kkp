...
@php($breadcrumbs = ['HOME'=>'/','標準薬品検索'=>'/medicine/','標準薬品登録'=>'javascript:void(0);'])
...
<div class="card card-primary apply_detail">
    <form class="form-horizontal" action="{{ route('medicine.regexec') }}" method="post" id="medicine-regist" accept-charset="utf-8">
        @csrf
        <div class="card-body">
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">薬品コード</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="kon_medicine_id" id="kon_medicine_id" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">文化連コード</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="bunkaren_code" id="bunkaren_code" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">12桁コード</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="code" id="code" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">個別医薬品コード</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="medicine_code" id="medicine_code" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">レセプト電算処理コード1</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="receipt_computerized_processing1" id="receipt_computerized_processing1" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">レセプト電算処理コード2</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="receipt_computerized_processing2" id="receipt_computerized_processing2" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">一般名</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="popular_name" id="popular_name" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">商品名</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="name" id="name" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">商品名読み</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="phonetic" id="phonetic" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">規格単位</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="standard_unit" id="standard_unit" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">包装形態</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="package_presentation" id="package_presentation" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">単位</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="unit" id="unit" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">薬価換算数</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="drug_price_equivalent" id="drug_price_equivalent" placeholder="" data-validate="empty" value="">
                </div>
            </div>
...
@foreach($medicine_effects as $medicine_effet)
                        <option value="{{ $medicine_effet->id }}" >{{ $medicine_effet->name }}</option>
@endforeach
                    </select>
                </div>
            </div>
...
@endforeach
            ...
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">経過措置期限</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="transitional_deadline" id="transitional_deadline" placeholder="" data-validate="empty" value="">
                </div>
            </div>
...
@endforeach
            ...
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">後発品フラグ</label>
                <div class="col-sm-3">
                    <select class="form-control" name="generic_product_flag" id="generic_product_flag">
                            <option value="" ></option>
@foreach($medicine_effects as $medicine_effet)
                        <option value="{{ $medicine_effet->id }}" >{{ $medicine_effet->name }}</option>
@endforeach
            ...
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">製造中止日</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="production_stop_date" id="production_stop_date" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">販売中止日</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="discontinuation_date" id="discontinuation_date" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">病院コード</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="hospital_code" id="hospital_code" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">オーナー区分（試薬区分）</label>
                <div class="col-sm-3">
...
@endforeach
            ...
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">JANコード</label>
                <div class="col-sm-2">
                    <input class="form-control validate" type="text" name="jan_code" id="jan_code" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">hotコード</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="hot_code" id="hot_code" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">表示用包装単位</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="display_pack_unit" id="display_pack_unit" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">包装数量</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="pack_count" id="pack_count" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">包装単位</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="pack_unit" id="pack_unit" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">総包装数量</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="total_pack_count" id="total_pack_count" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">総包装単位</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="total_pack_unit" id="total_pack_unit" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="row">
                <div class="col-1">
            ...
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">適用開始日</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="start_date" id="start_date" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group validateGroup row mb-2"><label class="form-control-label col-sm-3">適用終了日</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="end_date" id="end_date" placeholder="" data-validate="empty" value="">
                </div>
            </div>
            <div class="form-group row"><label class="col-sm-3 form-control-label" for="medicine_price"> 薬価（円）</label>
                <div class="col-sm-4">
                    <input class="form-control validate" type="text" name="price" id="price" placeholder="" data-validate="empty" value="">
                </div>
            </div>
        </div>
        <div class="card-footer d-flex justify-content-around pt15 pb15 mt15">
            <a class="btn btn-default btn-lg" href="/apply"><i class="fas fa-chevron-left mr10"></i>標準薬品一覧へ戻る</a>
            <div class="block">
