...
@php($breadcrumbs = ['HOME'=>'/', '利用申請一覧' => route('account.index'), '利用申請開始'=>'javascript:void(0);'])
...
<div class="card card-primary">
    <form class="form-horizontal" action="{{ route('account.start.exec', ['id '=> $viewdata->get('detail')->id]) }}" method="post" id="account-start" accept-charset="utf-8">
        @csrf
    ...
    <div class="d-flex justify-content-around pt15 pb15 card-footer"><a class="btn btn-default btn-lg" href="{{ route('account.index') }}"><i class="fas fa-chevron-left mr10"></i>アカウント申請一覧へ戻る</a>
        <div class="block">
