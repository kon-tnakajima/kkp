    ...
    <ul class="search-for-help">
      ...
      <li><a rel="noopener noreferrer" target="_blank"
				...
				title="Search for help in the PHP manual."> <!-- PHP icon by Icons Solid -->
					<!-- https://www.iconfinder.com/icons/322421/book_icon --> <!-- Free for commercial use -->
      ...
      <li><a rel="noopener noreferrer" target="_blank"
				...
				title="Search for help on Google."> <!-- Google icon by Alfredo H, from https://www.iconfinder.com/alfredoh -->
					...
					<svg class="google" height="16" viewBox="0 0 512 512" width="16"
						xmlns="http://www.w3.org/2000/svg">
            <path
			...
			<li><a rel="noopener noreferrer" target="_blank"
				...
				title="Search for help on DuckDuckGo."> <!-- DuckDuckGo icon by IconBaandar Team, from https://www.iconfinder.com/iconbaandar -->
					<!-- Creative Commons (Attribution 3.0 Unported) --> <!-- http://creativecommons.org/licenses/by/3.0/ -->
					<svg class="duckduckgo" height="16" viewBox="150 150 1675 1675"
			...
			<li><a rel="noopener noreferrer" target="_blank"
				...
				title="Search for help on Stack Overflow."> <!-- Stack Overflow icon by Picons.me, from https://www.iconfinder.com/Picons -->
					<!-- Free for commercial use --> <svg class="stackoverflow"
						height="16" viewBox="-1163 1657.697 56.693 56.693" width="16"
						xmlns="http://www.w3.org/2000/svg">
            <path
