...
interface ResultStatement extends Traversable {
	 ...
	 *
	 * @param int $fetchMode
	 *        	The fetch mode must be one of the {@link \Doctrine\DBAL\FetchMode} constants.
	 * @param mixed $arg2        	
	 * @param mixed $arg3        	
	 *
	 * @return bool
	 ...
	 *        	This argument has a different meaning depending on the value of the $fetchMode parameter:
