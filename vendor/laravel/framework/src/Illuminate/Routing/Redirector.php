...
class Redirector
{
    ...
    public function guest($path, $status = 302, $headers = [], $secure = null)
    {
        ...
        // START 2022/02/10 未ログイン状態で直リンクが叩かれたときに、ログイン後に直リンクに遷移するための改修
        ...
        if (!($request->method() === 'GET' && $request->route() && ! $request->expectsJson())) {
            $this->setIntendedUrl($this->generator->previous());
        }
        // END 2022/02/10 未ログイン状態で直リンクが叩かれたときに、ログイン後に直リンクに遷移するための改修
    ...
    public function intended($default = '/', $status = 302, $headers = [], $secure = null)
    {
        ...
        $result = $this->to($path, $status, $headers, $secure);
        return $result;
    }
