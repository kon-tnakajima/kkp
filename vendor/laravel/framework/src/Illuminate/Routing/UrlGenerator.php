...
class UrlGenerator implements UrlGeneratorContract
{
    ...
    public function to($path, $extra = [], $secure = null)
    {
        ...
        // START 2022/02/10 セッションが切れた状態からのログイン直後のURLが「http://localhost/kkp/public/index.php/kkp/public/index.php/login」などとおかしくなるバグの対応
        // $result = $this->format($root, '/'.trim($path.'/'.$tail, '/')).$query;
        $result = $this->format($root, '/'.trim($tail, '/')).$query;
        // END 2022/02/10 セッションが切れた状態からのログイン直後のURLが「http://localhost/kkp/public/index.php/kkp/public/index.php/login」などとおかしくなるバグの対応
