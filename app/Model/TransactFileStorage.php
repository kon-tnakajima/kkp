...
class TransactFileStorage extends BaseModel {
     ...
     * データ区分一覧を取得
     */
    public function getDataTypeList_old($user_group_id) {
    	$sql  = "";
    	$sql .= " select ";
    	...
    	$sql .= " where ";
    	$sql .= "     user_group_data_types.deleted_at is null ";
    	$sql .= "     and user_group_data_types.user_group_id = ".$user_group_id;
    	$sql .= " order by ";
    	$sql .= "     user_group_data_types.disp_order ";
