...
class Medicine extends BaseModel {
    ...
    public function listWithApplySql(Request $request, int $count, $user) {
        ...
        $sql .= '                            where fp.start_date <= now() and fp.end_date >= now() and fp.deleted_at is null    ';
        $sql .= '                                                      	';
        $sql .= '                            union	';
        $sql .= '                            select	';
        $sql .= '                              pa.medicine_id	';
...
*/
    ...
    public function getApplyGroupList($user_id, $status) {
        ...
        $sql  = ' select ';
        $sql .= '      a.sales_user_group_id as user_group_id ';
        $sql .= '     ,user_groups.name ';
        $sql .= ' from ';
        $sql .= ' (select ';
        $sql .= '      sales_user_group_id ';
        ...
        $sql .= '     on a.sales_user_group_id = user_groups.id ';
        $sql .= '     and user_groups.deleted_at is null ';
        $sql .= ' group by ';
        $sql .= '      a.sales_user_group_id ';
        $sql .= '     ,user_groups.name ';
    ...
    public function getApplyDetailData($user, $medicine_id, $fm_id, $fp_id, $pa_id, $fp_hon_id) {
        $sql  = 'SELECT * FROM';
        $sql .= " f_price_adoptions_unique_select_1204('" . $user->id . "', '" . $medicine_id . "', '" . $fm_id . "', '" . $fp_id . "', '" . $pa_id . "', '" . $fp_hon_id . "')";
