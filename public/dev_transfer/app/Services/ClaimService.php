...
class ClaimService extends BaseService {
    ...
    */
    ...
    public function regist(Request $request) {
    	...
    	$check = $this->transactFileStorage->checkFacilityDataType($request->facility, $data_name->data_type_name );
 ...
 /*
    ...
    */
    ...
    public function getPrivilegePurchasePrice($purchase_price, $show_purchase_price) {
    	...
    	$sql  = "";
    	$sql .= " select ";
    	$sql .= "      f_show_purchase_price2 as f_show_purchase_price ";
    	$sql .= " from ";
    	$sql .= "     f_show_purchase_price2(". $purchase_price . "," . $show_purchase_price . ")";
