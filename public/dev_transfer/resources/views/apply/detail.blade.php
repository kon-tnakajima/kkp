...
<div class="card card-primary apply_detail">
    ...
    @endif
            ...
            <table class="medicine-detail-table application-data pa-additional-info">
                <tbody>
                    <tr>
                    <th title=@if ($detail->edit_pa_besis_medicine_price > 0)"見積の基準とする薬価改定日を入力してください。初期値は現在の改定日です"@else"見積の基準となる薬価改定日です"@endif>薬価基準日@if ($detail->edit_pa_besis_medicine_price > 0)<span class="badge badge-danger ml-1">必須</span>@endif</th>
                        <td>
         @if ($detail->edit_pa_besis_medicine_price > 0)
