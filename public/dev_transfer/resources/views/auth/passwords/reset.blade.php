                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sub_id" type="text" class="form-control{{ $errors->has('sub_id') ? ' is-invalid' : '' }}" name="sub_id" value="{{$sub_id ?? old('sub_id') }}" readonly>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">新しいパスワード再入力</label>
