...
class ClaimService extends BaseService {
    ...
    public function getUserGroupClaimRegistFacility($user) {
        $this->start_log();
        $result = $this->userGroup->getUserGroupsFacility($user,'claimRegist');
        $this->end_log();
        return $result;
    }
    ...
    public function getUserGroupClaimRegist($user) {
        $this->start_log();
        $result = $this->userGroup->getUserGroupsFacility($user,'claimRegistList');
        $this->end_log();
        return $result;
    }
    ...
    public function getUserGroupClaim($user) {
        $this->start_log();
        $result = $this->userGroup->getUserGroupsFacility($user,'claimCheck');
        $this->end_log();
        return $result;
    }
 ...
 /*
    ...
    public function getConditions(Request $request) {
        ...
        if (!empty($request->is_search)) {
            ...
            $conditions['is_condition_search'] = $is_cond;
