...
@if ($detail->$edit_kengen > 0)
    <div class="relative-box">
        ...
        @include('layouts.input', ['parent' => '[apply.detail]', 'name' => $price_name, 'value' => isset($detail->$price_name) ? number_format($detail->$price_name, $decimal_point, '', '') : '', 'type' => 'tel', 'class' => $price_name . ($require_flag ? ' require' : ''). ' price', 'other_attr' => 'data-validate=empty zero oninput=priceRateDynamicUpdate(event) autocomplete=off' ])
    </div>
